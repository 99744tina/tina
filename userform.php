...
Age (Years)
	 ...
	 <input type="text" name="Age" id="fname" class="form-control" placeholder="Age (years)" required>
                                ...
                                <div class="form-group">
<label>
T3 (Normal Range is  5.0 to 12.0 micrograms per deciliter (μg/dL))
</label>
...
TT4 (Normal Range is  11.8-22.6 mcg/dL micrograms per deciliter)
</label>
 ...
 <div class="form-group">
<abel>
T4U (Normal Range is  0.5 to 5.0 mIU/L micrograms per deciliter )
	 ...
	 <input type="text" name="T4U" id="fname" class="form-control" placeholder="T4U" required>
								...
								<div class="form-group">
								  ...
								  <label>Pre Glucose Level (Plasma glucose concentration a 2 hours in an oral glucose tolerance test) Normal Range less 140  </label>
	 <input type="text" name="Glucose" id="fname" class="form-control" placeholder="Glucose Level (Plasma glucose concentration a 2 hours in an oral glucose tolerance test)" required>
		...
		<label>Post meal Glucose Level Normal Range less 140 </label>
...
Cholestoral (serum cholestoral in mg/dl) Normal Range is 200–239
</label>
